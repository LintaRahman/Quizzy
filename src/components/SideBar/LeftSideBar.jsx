...
import {downloadTranscript, requestFeedback} from "../../services/chats.js";
...
const RightNav = ({ open }) => {
  ...
  return (
    ...
    <SideBar open={open}>
      {feedback != '' ? <BasicModal title='Feedback' content={feedback}/> : null}
      ...
      <div className="logo">Quizzy</div>
          ...
          <button
            ...
            <p>
                    ...
                    <p>Interview for {parameters.job}</p>
            </div>
